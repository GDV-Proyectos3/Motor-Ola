...
void OgreManager::init()
{
	...
	// Esto todav�a no funciona porque falta el Resource Manager
...
void OgreManager::createRoot()
{
	...
	_solutionPath = pluginsPath;    // IG2: a�adido para definir directorios relativos al de la soluci�n 
	_solutionPath.erase(_solutionPath.find_last_of("\\") + 1, _solutionPath.size() - 1);
	_fileSystemLayer->setHomePath(_solutionPath);   // IG2: para los archivos de configuraci�n ogre. (en el bin de la solubi�n)
